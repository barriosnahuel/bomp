...
(function () {
  ...
  var LANG = {
    "es-AR": {
      ...
      "shot.list.row1": "Risa de mi vieja",
      "shot.list.row2": "Che capo",
      "shot.list.row3": "Buen día rey",
      "shot.list.row4": "La frase del jefe",
      "shot.list.timeAgo": "hace",
      "shot.list.day": "d",
      "shot.import.title": "Trae ese audio que te gusta",
      "shot.import.heading": "Compartilo desde otra app",
      "shot.import.row": "Risa de mi vieja",
      "shot.import.rowMeta": "Importado recién",
      "shot.search.matchPrefix": "Ris",
      "shot.search.matchRest": "a de mi vieja",
      "shot.search.duration": "0:01",
      "shot.search.timeAgo": "hace 1d",
      "shot.search.kbSpace": "espacio",
      "shot.search.kbGo": "ir",
      "shot.caption.list": "↳ La risa que te alegra el lunes",
      "shot.caption.import": "↳ Importá desde WhatsApp, Telegram, WeChat",
      "shot.caption.search": "↳ Tipeá, encontrá, Bompeá",
    ...
    "es-419": {
      ...
      "section.app.title": "Tus voces, en orden.",
      "shot.list.title": "Mis audios",
      "shot.list.row1": "Risa de mi mamá",
      "shot.list.row2": "Hey wey",
      "shot.list.row3": "Buen día",
      "shot.list.row4": "La frase del jefe",
      "shot.list.timeAgo": "hace",
      "shot.list.day": "d",
      "shot.import.title": "Trae ese audio que te gusta",
      "shot.import.heading": "Compártelo desde otra app",
      "shot.import.row": "Risa de mi mamá",
      "shot.import.rowMeta": "Importado recién",
      "shot.search.matchPrefix": "Ris",
      "shot.search.matchRest": "a de mi mamá",
      "shot.search.duration": "0:01",
      "shot.search.timeAgo": "hace 1d",
      "shot.search.kbSpace": "espacio",
      "shot.search.kbGo": "ir",
      "shot.caption.list": "↳ La risa que te alegra el lunes",
      "shot.caption.import": "↳ Importa desde WhatsApp, Telegram, WeChat",
      "shot.caption.search": "↳ Escribe, encuentra, Bompea",
    ...
    "es-ES": {
      ...
      "shot.list.title": "Mis audios",
      "shot.list.row1": "Risa de mi madre",
      "shot.list.row2": "Tío",
      "shot.list.row3": "Buenos días",
      "shot.list.row4": "La frase del jefe",
      "shot.list.timeAgo": "hace",
      "shot.list.day": "d",
      "shot.import.title": "Trae ese audio que te gusta",
      "shot.import.heading": "Compártelo desde otra app",
      "shot.import.row": "Risa de mi madre",
      "shot.import.rowMeta": "Importado recién",
      "shot.search.matchPrefix": "Ris",
      "shot.search.matchRest": "a de mi madre",
      "shot.search.duration": "0:01",
      "shot.search.timeAgo": "hace 1d",
      "shot.search.kbSpace": "espacio",
      "shot.search.kbGo": "ir",
      "shot.caption.list": "↳ La risa que te alegra el lunes",
      "shot.caption.import": "↳ Importa desde WhatsApp, Telegram, WeChat",
      "shot.caption.search": "↳ Teclea, encuentra, Bompea",
    ...
    "en": {
      ...
      "shot.list.row1": "Mom's laugh",
      "shot.list.row2": "Yo dude",
      "shot.list.row3": "Good morning king",
      "shot.list.row4": "Boss said it again",
      "shot.list.timeAgo": "",
      "shot.list.day": "d ago",
      "shot.import.title": "Bring in that audio you love",
      "shot.import.heading": "Share it from another app",
      "shot.import.row": "Mom's laugh",
      "shot.import.rowMeta": "Just imported",
      "shot.search.matchPrefix": "Lau",
      "shot.search.matchRest": "gh from mom",
      "shot.search.duration": "0:01",
      "shot.search.timeAgo": "1d ago",
      "shot.search.kbSpace": "space",
      "shot.search.kbGo": "go",
      "shot.caption.list": "↳ The laugh that brightens your Monday",
      "shot.caption.import": "↳ Import from WhatsApp, Telegram, WeChat",
      "shot.caption.search": "↳ Type, find, Bomp",
    ...
    "pt-BR": {
      ...
      "shot.list.row1": "Risada da mãe",
      "shot.list.row2": "E aí mano",
      "shot.list.row3": "Bom dia rei",
      "shot.list.row4": "Frase do chefe",
      "shot.list.timeAgo": "há",
      "shot.list.day": "d",
      "shot.import.title": "Traz aquele áudio que tu curte",
      "shot.import.heading": "Compartilhe de outro app",
      "shot.import.row": "Risada da mãe",
      "shot.import.rowMeta": "Importado agora",
      "shot.search.matchPrefix": "Ris",
      "shot.search.matchRest": "ada da mãe",
      "shot.search.duration": "0:01",
      "shot.search.timeAgo": "há 1d",
      "shot.search.kbSpace": "espaço",
      "shot.search.kbGo": "ir",
      "shot.caption.list": "↳ A risada que alegra a sua segunda",
      "shot.caption.import": "↳ Importe do WhatsApp, Telegram, WeChat",
      "shot.caption.search": "↳ Digite, encontre, Bompe",
