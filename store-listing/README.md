...
│   │   ├── screenshots.md          # capture + compose pipeline spec (6 scenes)
│   │   ├── screenshot-01-home.svg … screenshot-06-closing.svg  # 4 hybrid + 2 typography SVGs
...
│       ├── phone/                  # 01-home … 06-closing, each as *-<locale>.png (6 scenes)
...
│   ├── changelog-6.txt
│   ├── briefs/                     # icon-512.svg + feature-graphic.svg + 6 screenshot-*.svg + .md briefs
...
The 6-scene set: `01-home`, `02-collections`, `03-vault`, `04-immersive`, `05-manifesto`, `06-closing` (manifesto + closing are full-vector typography, not captured).
