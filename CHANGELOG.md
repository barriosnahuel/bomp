...
- Initial Google Play Store listing assets in es-AR and en-US under `store-listing/`: title, short and full description (with zero-friction onboarding and Auto Backup to Drive featured as headline differentials), what's new, brand mark SVG, design briefs for icon, feature graphic, four phone screenshots (the last one a manifesto card) and preview video
